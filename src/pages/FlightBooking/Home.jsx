...
import RecentSearches from "../../pages/FlightBooking/flightsearch/RecentSearches";
...
function HomeHeroInline() {
  ...
  const [heroCss, setHeroCss] = useState({
    ...
    cardInner:
      "linear-gradient(135deg, rgba(255,255,255,0.92) 0%, rgba(255,255,255,0.98) 40%, rgba(16,182,217,0.14) 100%)",
  ...
  const recompute = useCallback(() => {
    ...
    const o1 = isDark ? 0.78 : 0.7;
    const o2 = isDark ? 0.52 : 0.45;
    const o3 = isDark ? 0.86 : 0.8;
      ...
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-3 z-10 flex flex-col items-center gap-2">
          <div className="flex flex-col items-center">
            <div className="text-[11px] font-extrabold tracking-wide text-white/80">Scroll to explore</div>
