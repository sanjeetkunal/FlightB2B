      ...
      <div className="mx-auto max-w-7xl px-0 py-6">
        ...
        <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-[150px] rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-center text-xs font-semibold text-slate-800">
              {monthLabel}
            </div>
            <button
              onClick={goNextMonth}
        ...
        <div className="mt-4 rounded-xl border border-slate-200 bg-white p-3 text-[11px] shadow-sm">
