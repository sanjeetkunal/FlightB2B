...
export const FLIGHTS: FlightRow[] = [
  ...
  /* ===== DXB → DEL — 2026-01-25 (Return for DEL–DXB Round Trip) ===== */
{
  id: "AI-916-INT-RT",
  airline: "Air India",
  logo: LOGOS.airIndia,
  ...
  departTime: "07:45", departDate: "2026-01-25",
  arriveTime: "13:15", arriveDate: "2026-01-25",
  stops: 0, stopLabel: "Non-stop",
  durationMin: 240,
  refundable: "Refundable",
  fares: [
    {
      fareId: "AI916INT25-ECO-SAVER",
      brand: "Saver",
      cabin: "Economy",
      rbd: "V",
      baggageKg: 25,
...
},
{
  ...
  fromCity: "Dubai", fromIata: "DXB",
  toCity: "New Delhi", toIata: "DEL",
  departTime: "11:30", departDate: "2026-01-25",
  arriveTime: "17:00", arriveDate: "2026-01-25",
  stops: 0, stopLabel: "Non-stop",
  durationMin: 240,
  refundable: "Refundable",
  fares: [
    {
      fareId: "6E1452INT25-ECO-SAVER",
      brand: "Saver",
      cabin: "Economy",
      rbd: "V",
      baggageKg: 20,
...
},
{
  ...
  fromCity: "Dubai", fromIata: "DXB",
  toCity: "New Delhi", toIata: "DEL",
  departTime: "15:20", departDate: "2026-01-25",
  arriveTime: "20:10", arriveDate: "2026-01-25",
  stops: 0, stopLabel: "Non-stop",
  durationMin: 290,
  refundable: "Refundable",
  fares: [
    {
      fareId: "UK202INT25-ECO-SAVER",
      brand: "Saver",
      cabin: "Economy",
      rbd: "V",
      baggageKg: 25,
    ...
    /* ===== DEL → DXB — 2026-01-20 (5 flights) ===== */
  {
    ...
    departTime: "06:30", departDate: "2026-01-20",
    arriveTime: "09:00", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 240,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Dubai", toIata: "DXB",
    departTime: "09:45", departDate: "2026-01-20",
    arriveTime: "12:15", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 240,
    refundable: "Refundable",
    fares: [
  ...
  /* ===== DXB → DEL — 2026-01-20 (5 flights, same date for return) ===== */
  {
    id: "AI-916-INT",
    airline: "Air India",
    logo: LOGOS.airIndia,
    ...
    fromCity: "Dubai", fromIata: "DXB",
    toCity: "New Delhi", toIata: "DEL",
    departTime: "07:45", departDate: "2026-01-20",
    arriveTime: "13:15", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 240,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "Dubai", fromIata: "DXB",
    toCity: "New Delhi", toIata: "DEL",
    departTime: "11:30", departDate: "2026-01-20",
    arriveTime: "17:00", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 240,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "Dubai", fromIata: "DXB",
    toCity: "New Delhi", toIata: "DEL",
    departTime: "15:20", departDate: "2026-01-20",
    arriveTime: "20:10", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 290,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "Dubai", fromIata: "DXB",
    toCity: "New Delhi", toIata: "DEL",
    departTime: "19:05", departDate: "2026-01-20",
    arriveTime: "00:35", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 240,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "Dubai", fromIata: "DXB",
    toCity: "New Delhi", toIata: "DEL",
    departTime: "23:50", departDate: "2026-01-20",
    arriveTime: "05:20", arriveDate: "2026-01-20",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 270,
    refundable: "Refundable",
    fares: [
  ...
  /* ===== DEL → BOM — 2026-01-28 (15 flights) ===== */
  {
    ...
    departTime: "06:30", departDate: "2026-01-28",
    arriveTime: "08:50", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 140,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "07:30", departDate: "2026-01-28",
    arriveTime: "09:55", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 145,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "09:10", departDate: "2026-01-28",
    arriveTime: "11:20", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 130,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "10:20", departDate: "2026-01-28",
    arriveTime: "13:35", arriveDate: "2026-01-28",
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "11:45", departDate: "2026-01-28",
    arriveTime: "14:05", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 140,
    refundable: "Refundable",
    fares: [
...

  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "14:10", departDate: "2026-01-28",
    arriveTime: "16:30", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 140,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "15:00", departDate: "2026-01-28",
    arriveTime: "17:30", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 150,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "17:20", departDate: "2026-01-28",
    arriveTime: "19:45", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 145,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "18:40", departDate: "2026-01-28",
    arriveTime: "22:10", arriveDate: "2026-01-28",
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "19:30", departDate: "2026-01-28",
    arriveTime: "22:00", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 150,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "20:10", departDate: "2026-01-28",
    arriveTime: "22:40", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 150,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "21:05", departDate: "2026-01-28",
    arriveTime: "23:20", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 135,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "22:10", departDate: "2026-01-28",
...

  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "05:55", departDate: "2026-01-28",
    arriveTime: "09:20", arriveDate: "2026-01-28",
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "08:05", departDate: "2026-01-28",
    arriveTime: "10:35", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 150,
    refundable: "Refundable",
    fares: [
  ...
  },
  {
    ...
    fromCity: "New Delhi", fromIata: "DEL",
    toCity: "Mumbai", toIata: "BOM",
    departTime: "16:20", departDate: "2026-01-28",
    arriveTime: "18:55", arriveDate: "2026-01-28",
    stops: 0, stopLabel: "Non-stop",
    durationMin: 155,
    refundable: "Refundable",
    fares: [
