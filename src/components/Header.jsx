      ...
      <div className="border border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="h-16 flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center gap-3 overflow-x-auto">
                {tabs.map((t) => {
                  ...
                  return (
                    ...
                    >
                      {/* Icons are optional – uncomment to show */}
                      {/* <Icon /> */}
            ...
            {/* Right: Wallet, Notifications, Profile — HIDE on public */}
            {!isPublic && (
...
/* icons */
function AirplaneIcon({ className }) { return <img src="https://cdn-icons-png.flaticon.com/128/6789/6789671.png" className={className || "w-[35px]"} alt="Flights" />; }
function HotelIcon({ className })    { return <img src="https://cdn-icons-png.flaticon.com/128/10472/10472597.png" className={className || "w-[35px]"} alt="Hotels" />; }
function TrainIcon({ className })    { return <img src="https://cdn-icons-png.flaticon.com/128/8713/8713890.png" className={className || "w-[35px]"} alt="Trains" />; }
function BusIcon({ className })      { return <img src="https://cdn-icons-png.flaticon.com/128/4707/4707853.png" className={className || "w-[35px]"} alt="Buses" />; }
